...
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/BjhonStore/Bjhon/main/setup.sh && chmod +x setup.sh && ./setup.sh
```

## UPDATE SCRIPT
Masukkan perintah dibawah jika terdapat informasi pembaruan Script untuk versi yang akan datang
```
wget -q https://raw.githubusercontent.com/BjhonStore/Bjhon/main/update.sh && chmod +x update.sh && ./update.sh
```
...
<h1 align="center"> Supported Linux Distribution</h2>
